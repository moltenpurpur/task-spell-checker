...
ALPH = {
    'Р°': 'Р°', 'Р±': 'Рї', 'РІ': 'С„', 'Рі': 'Рє', 'Рґ': 'С‚',
    'Рµ': 'Рё', 'С‘': 'Р°', 'Р¶': 'С€', 'Р·': 'СЃ', 'Рё': 'Рё',
    'Р№': 'Рё', 'Рє': 'Рє', 'Р»': 'Р»', 'Рј': 'Рј', 'РЅ': 'РЅ',
    'Рѕ': 'Р°', 'Рї': 'Рї', 'СЂ': 'СЂ', 'СЃ': 'СЃ', 'С‚': 'С‚',
    'Сѓ': 'Сѓ', 'С„': 'С„', 'С…': 'С…', 'С†': 'С€', 'С‡': 'С€',
    'С€': 'С€', 'С‰': 'С€', 'СЉ': '', 'С‹': 'Рё', 'СЊ': '',
    'СЌ': 'Рё', 'СЋ': 'Сѓ', 'СЏ': 'Р°', '-': ''
}
BIGRAMS = {
    'cc': 'c', 'С‚СЃ': 'С†', 'РґС†': 'С†', 'С…Рі': 'Рі', 'СЃС‡': 'С€',
    'Р·С‡': 'С€', 'Р¶С‡': 'С€', 'СЃС€': 'С€', 'СЃС‰': 'С€', 'С‚С‡': 'С€'
}
TRIGRAMS = {
    'СЃС‚РЅ': 'СЃРЅ', 'РЅРґС€': 'РЅС€', 'СЃС‚Р»': 'СЃР»', 'Р·РґРЅ': 'Р·РЅ',
    'Р·РґС†': 'СЃС†', 'Р»РЅС†': 'РЅС†', 'РЅРґС†': 'РЅС†', 'РЅС‚Рі': 'РЅРі',
    'СЂРґС†': 'СЂС†', 'СЂРґС‡': 'СЂС‡', 'СЃС‚Рі': 'СЃРі'
}
FOURGRAMS = {
    'РІСЃС‚РІ': 'СЃС‚РІ'
}
...
def make_correct_line(line):
    return re.compile('[^Р°-СЏРђ-РЇС‘РЃ\\- ]').sub('', line).split()


def make_list(word_string):
    word_list = str(word_string)
    return re.compile('[^Р°-СЏС‘\\- ]').sub('', word_list).split()
